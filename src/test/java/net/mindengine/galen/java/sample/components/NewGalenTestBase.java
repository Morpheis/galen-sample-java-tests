...
@Listeners({GalenReportingListener.class})
public class NewGalenTestBase {
    private static final String ENV_URL = "http://bodyspace.bodybuilding.com";
    ...
    public Object [][] devices () {
        return new Object[][] {
                {new TestDevice("mobile", new Dimension(768, 800), asList("mobile"))},
                {new TestDevice("tablet", new Dimension(1024, 800), asList("tablet"))},
